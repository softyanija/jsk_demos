...
pub_image = rospy.Publisher('/timer_cam1_rec/lever/around_image', Image, queue_size=1)
pub_mask = rospy.Publisher('/timer_cam1_rec/lever/around_image/debug_image', Image, queue_size=1)

sub_img = message_filters.Subscriber('/timer_cam1/timer_cam_image/image_rect_color', Image)
sub_rect = message_filters.Subscriber('/timer_cam1_rec/socket/general_contours/rectangles', RotatedRectArrayStamped)
