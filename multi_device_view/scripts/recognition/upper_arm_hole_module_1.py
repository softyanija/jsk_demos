...
class UpperArmHole():
    ...
    def __init__(self,
        ...
        self.parts_detect_rect = ((460, 2), (840, 240))
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.sub_color_image is not None:
                ...
                rospy.logwarn("upper_arm_hole_module_1 :not recieve image")


if __name__ == "__main__":

    rospy.init_node("upper_arm_hole_module_1")

    upper_arm_hole = UpperArmHole("module_1", "normal")
