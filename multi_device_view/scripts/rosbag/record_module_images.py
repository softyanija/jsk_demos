...
save_dir = os.path.join("/home/amabe/rosbag/distributed", date_str[0] + "-" + date_str[1])
...
command = ["roslaunch", "multi_device_view", "record_module_images.launch","rosbag:=" + rosbag]
print(command)
