...
robot.angle_vector(ri.angle_vector())
robot.rarm.move_end_pos([0, 0, -0.001], "world")

# adjust pos
diff_range_mm = 100
while diff_range_mm > 0.7:
...
rospy.loginfo("Finished tighten screw")

robot.angle_vector(ri.angle_vector())
robot.rarm.move_end_pos([0, 0, 0.05], "world")
ri.angle_vector(robot.angle_vector(), 3)
ri.wait_interpolation()
...
robot.angle_vector(ri.angle_vector())
robot.larm.move_end_pos([0, 0.1, 0.1], "world")
robot.rarm.move_end_pos([0, -0.1, 0], "world")
ri.angle_vector(robot.angle_vector(), 3)
ri.wait_interpolation()
